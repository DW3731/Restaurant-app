  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        // Adjust the height to fit the content properly
        toolbarHeight: 80, // Adjust the height as needed
        title: Padding(
          padding: const EdgeInsets.only(top: 0.0), // Remove top padding
          child: Image.asset(Images.logo, width: 90, height: 90),
        ),
        actions: [
          Padding(
            padding: const EdgeInsets.only(right: 16.0), // Add right padding if needed
            child: IconButton(
              icon: GetBuilder<NotificationController>(builder: (notificationController) {
                ...
                return Stack(
                  children: [
                    ...
                    if (hasNewNotification) Positioned(
                      top: 0,
                      right: 0,
                      child: Container(
                        height: 10,
