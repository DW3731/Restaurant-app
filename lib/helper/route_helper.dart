...
import 'package:stackfood_multivendor_restaurant/features/story/story_screen.dart';
...
class RouteHelper {
  ...
  static String getStoryRoute() => '/story';
  ...
  static List<GetPage> routes = [
    GetPage(name: getStoryRoute(), page: () => StoryScreen()),
